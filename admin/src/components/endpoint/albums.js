...
export const AlbumList = (props) => (
    <List filters={<FilterData />} {...props} title="Tous les albums">
      <Datagrid rowClick="edit">
        <TextField label={'Nom de l\'album'} source="fullName" />
...
export const AlbumEdit = (props) => (
    <Edit {...props}>
      <SimpleForm>
        <TextInput source="id" />
        <ReferenceInput label="Choix de l'artist" source="ArtistId" reference="artists">
          <SelectInput optionText="name" />
        </ReferenceInput>
        ...
        <ReferenceInput label="Choix de l'album" source="StyleId" reference="styles">
          <SelectInput optionText="name" />
        </ReferenceInput>
